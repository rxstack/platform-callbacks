...
// peer depencencies
npm install @rxstack/core@^0.4 @rxstack/async-event-dispatcher@^0.4  @rxstack/platform@^0.4 @rxstack/exceptions@^0.4 @rxstack/query-filter@^0.4 @rxstack/security@^0.4 @rxstack/utils@^0.4 @rxstack/service-registry@^0.4 
```
