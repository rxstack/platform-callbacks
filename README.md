...
// peer depencencies
npm install @rxstack/core@^0.3 @rxstack/async-event-dispatcher@^0.3  @rxstack/platform@^0.3 @rxstack/exceptions@^0.3 @rxstack/query-filter@^0.3 @rxstack/security@^0.3 @rxstack/utils@^0.3 @rxstack/service-registry@^0.3 
```
